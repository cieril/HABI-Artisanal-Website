        ...
        <main class="main-container">
            ...
            <div class="main-cards">
                <div class="card">
                    ...
                    <?php
                        $dash_order_query = "SELECT * FROM orders WHERE status='4' ";
                ...
                <div class="card">
                    ...
                    <?php
                        $dash_revenue_query = "SELECT SUM(total_price) AS total_revenue FROM orders";
                        $dash_revenue_query_run = mysqli_query($con, $dash_revenue_query);

                        if ($dash_revenue_query_run) {
                            $row = mysqli_fetch_assoc($dash_revenue_query_run);
                            $revenue_total = $row['total_revenue'];
