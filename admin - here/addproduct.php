           ...
           <div class="addproduct_wrapper">
            <form class="addproduct_form" action="code.php" enctype="multipart/form-data" method="POST">
                ...
                <div class="input_product">
                    ...
                    <textarea type="text" name="small_description" id="small_description"  autocomplete="off" required></textarea>
                </div>
                <div class="input_product">
                ...
                <div class="input_product">
                    ...
                    <input type="number" name="original_price" id="original_price" autocomplete="off" required>
                </div>
                <div class="input_product">
                    <label for="selling_price"> Selling Price  </label>
                    <input type="number" name="selling_price" id="selling_price" autocomplete="off" required>
                </div>
                <div class="input_product">
                ...
                <div class="input_product">
                    ...
                    <input type="number" name="qty" id="qty" autocomplete="off" required>
                </div>
                <div class="radio_wrapper">
                    ...
                    <div class="input_radio">
                        ...
                        <input type="checkbox" name="trending" id="trending" autocomplete="off">
                    </div>
                </div>
                <div class="input_product">
                ...
                <div class="button_submit">
                    <button name="add_product_btn" type="submit"> Add Product </button>
                </div>
            </form>
           </div>
        </main>
