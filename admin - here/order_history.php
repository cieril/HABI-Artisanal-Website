...
<body>
    <div class="grid-container">
        ...
        <main class="main-container" id="category_table">
            <div>
                <a href="orders.php" class="back"> < Go Back </a>
            </div>
            <table class="products-table">
                ...
                <tbody>
                    <?php
                        $category = getOrderHistory('categories');
                    ...
                    ?>
                        <tr>
                            ...
                            <td> <?= $item['card_message'] ?></td>
                            <td> 
                                <a href="view_order.php?t=<?= $item['tracking_no']?>" class="view"> View </a>
                            </td>
                        </tr>
                    <?php
                            }
