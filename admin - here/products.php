...
<body>
    <div class="grid-container">
        ...
        <!-- Main -->
        <main class="main-container" id="products_table">
            <div class="main-title">
                <a href="addproduct.php"><button class="add">Add Product</button></a>
            </div>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td> 
                                <a href="edit_product.php?id=<?= $item['id'] ?>" class="edit"> EDIT </a>
                            </td>
                            <td>
                                <button type="button" class="delete_product_btn" value="<?= $item['id'] ?>"> DELETE </button>
                            </td>
                        </tr>
                    <?php
                            }
