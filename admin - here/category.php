...
<body>
    <div class="grid-container">
        ...
        <!-- Main -->
        <main class="main-container" id="category_table">
            <div class="main-title">
                <a href="addcategory.php"><button class="add">Add Category</button></a>
            </div>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td> 
                                <a href="edit_category.php?id=<?= $item['id'] ?>" class="edit"> Edit </a>
                            </td>
                            <td>
                                <button type="button" class="delete_category_btn" value="<?= $item['id'] ?>"> Delete </button>
